...
initialiseurF = {"jaro": 0, "jaccard": 0, "monge_elkan": 0, "numSimilarity": 0, "ngram1": 0,"ngram2":0, "levenshtein": 0, "jaroWrinkler": 0,"uriEquality": 0}
seuil = 0.5


layout = [[sg.T("                                                                      OUTIL COMPARAISON RDF (F22)         ")], [sg.T("")],
          [sg.T("Choisissez les propriétés à comparer"), sg.T("                         Choisissez les mesures"), ],
          [sg.T("                   "), sg.Checkbox('Clef', default=False, key="ClefC"),sg.T("                                      "), sg.Checkbox('Jaro', default=False, key="JaroC"),sg.T("              "),sg.InputText( key='1')],
          [sg.T("                   "), sg.Checkbox('Titre', default=False, key="TitreC"),sg.T("                                      "), sg.Checkbox('Jaccar', default=False, key="JaccarC"),sg.T("          "),sg.InputText( key='2')],
          [sg.T("                   "), sg.Checkbox('Note', default=False, key="NoteC"),sg.T("                                     "), sg.Checkbox('Monge Elkan', default=False, key="MongeC"),sg.T(" "),sg.InputText( key='3')],
          [sg.T("                   "), sg.Checkbox('Genre', default=False, key="GenreC"),sg.T("                                   "), sg.Checkbox('NumSimilarity', default=False, key="NumSimilarityC"),sg.T(""),sg.InputText( key='4')],
          [sg.T("                   "), sg.Checkbox('Compositeur', default=False, key="CompositeurC"),sg.T("                          "), sg.Checkbox('Ngram', default=False, key="NgramC"),sg.T("           "),sg.InputText( key='5')],
          [sg.T("                   "), sg.Checkbox('Opus', default=False, key="OpusC"),sg.T("                                              Ngram Size       "),sg.InputText( key='5-2')],
          [sg.T("                                                                            "), sg.Checkbox('Levenshtein', default=False, key="LevenshteinC"),sg.T("    "),sg.InputText( key='6')],
          [sg.T("                                                                            "), sg.Checkbox('JaroWrinkler', default=False, key="JaroWrinklerC"),sg.T("   "),sg.InputText( key='7')],
          [sg.T("                     Seuil"),sg.InputText(size=(10, 2), key='0'),sg.T("                       "), sg.Checkbox('uriEquality', default=False, key="UriEqualityC"),sg.T("      "),sg.InputText( key='8')],
          [sg.T("")] ,[sg.T("                                                                                         "), sg.Button('Submit' ,size=(20,4))]]
...
while True:
    ...
    if event == 'Submit':
        ...
        print("-")
        compareExpressions(g1, g2, initialiseurP["clef"], initialiseurP["titre"], initialiseurP["genre"], initialiseurP["opus"], initialiseurP["note"], initialiseurP["compositeur"], initialiseurF["jaro"], initialiseurF["jaroWrinkler"], initialiseurF["numSimilarity"],
                           initialiseurF["uriEquality"], seuil)

    ...
    with concurrent.futures.ProcessPoolExecutor() as executor:
        ...
        for exp1 in expressions1:
            ...
            for exp2 in expressions2:
                ...
                nombre = 0
                if clef > 0:
                    futures.append(executor.submit(compareProriete,exp1, exp2, g1, g2, "clef", jaro1, jaroWrinkler1, numSimilarity1, uriEquality1,
                                         ngram1, ngram2, jaccard1, monge_elkan1, levenshtein1))
                    nombre += 1
                if titre > 0:
                    futures.append(executor.submit(compareProriete,exp1, exp2, g1, g2, "titre", jaro1, jaroWrinkler1, numSimilarity1,
                                            uriEquality1, ngram1, ngram2, jaccard1, monge_elkan1, levenshtein1))
                    nombre += 1
                if genre > 0:
                    futures.append(executor.submit(compareProriete,exp1, exp2, g1, g2, "genre", jaro1, jaroWrinkler1, numSimilarity1,
                                         uriEquality1, ngram1, ngram2, jaccard1, monge_elkan1, levenshtein1))
                    nombre += 1
                if opus > 0:
                    futures.append(executor.submit(compareProriete,exp1, exp2, g1, g2, "opus", jaro1, jaroWrinkler1, numSimilarity1, uriEquality1,
                                         ngram1, ngram2, jaccard1, monge_elkan1, levenshtein1))
                    nombre += 1
                if note > 0:
                    futures.append(executor.submit(compareProriete,exp1, exp2, g1, g2, "note", jaro1, jaroWrinkler1, numSimilarity1, uriEquality1,
                                         ngram1, ngram2, jaccard1, monge_elkan1, levenshtein1))
                    nombre += 1
                if compositeur > 0:
                    futures.append(executor.submit(compareProriete,exp1, exp2, g1, g2, "compositeur", jaro1, jaroWrinkler1, numSimilarity1,
                                         uriEquality1, ngram1, ngram2, jaccard1, monge_elkan1, levenshtein1))
                    nombre += 1
